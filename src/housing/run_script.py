...
# we add argparse here. The option '--datapath' will accept path as an argument from
# the user, which will be used to store the training and validation datasets.
